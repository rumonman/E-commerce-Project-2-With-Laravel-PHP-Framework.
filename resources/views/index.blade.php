	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm col-md-6 col-lg ftco-animate">
				<div class="product">
					<a href="#" class="img-prod"><img class="img-fluid" src="{{asset('upload/photos/main')}}/{{$pro->product_image}}" alt="Colorlib Template"></a>
					<div class="text py-3 px-3">
						...
						<p class="bottom-area d-flex">
							<a href="{{url('/details')}}/{{$pro->id}}" class="add-to-cart"><span>DETAILS <i class="ion-ios-add ml-1"></i></span></a>
...
<section class="ftco-section bg-light">
	<div class="container">
		<div class="row justify-content-center mb-3 pb-3">
			<div class="col-md-12 heading-section text-center ftco-animate">
				<h1 class="big">Products</h1>
				<h2 class="mb-4">Future Products</h2>
			</div>
		</div>
	</div>
	<div class="container-fluid">
		<div class="row">
			@foreach($all_futures as $future)
			<div class="col-sm col-md-6 col-lg ftco-animate">
				<div class="product">
					<a href="#" class="img-prod"><img class="img-fluid" src="{{asset('upload/future/main')}}/{{$future->product_image}}" alt="Colorlib Template"></a>
					<div class="text py-3 px-3">
						<h3><a href="#">{{$future->name}}</a></h3>
						...
						<hr>
						<p class="bottom-area d-flex">
							<a href="{{url('/future/details')}}/{{$future->id}}" class="add-to-cart"><span>DETAILS <i class="ion-ios-add ml-1"></i></span></a>
							<a href="#" class="ml-auto"><span><i class="ion-ios-heart-empty"></i></span></a>
						</p>
					</div>
				</div>
...
<section class="ftco-section ftco-section-more img" style="background-image: url(frontend/images/bg_5.jpg);">
	<div class="container">
		<div class="row justify-content-center mb-3 pb-3">
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(frontend/images/bg_4.jpg);">
	<div class="container">
