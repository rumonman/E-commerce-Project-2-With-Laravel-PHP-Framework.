  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 order-md-last d-flex">
        ...
        @endif
        <form action="{{url('/contuct/insert')}}" method="post" class="bg-white p-5 contact-form">
          @csrf
    ...
    <div class="row d-flex mt-5 contact-info">
      ...
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Address:</span> House no: 01, Road No: 17, Sector: 10, Uttara, Dhaka, Bangladesh.</p>
        </div>
      </div>
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Phone:</span> <a href="#">+8801717877561</a></p>
        </div>
      </div>
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Email:</span> <a href="#">info@modist.com</a></p>
        </div>
      </div>
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Website</span> <a href="#">modist.com</a></p>
        </div>
      </div>
    </div>
  </div>
